  ...
  return (
    <div>
      ...
      >
        <Card sx={{ maxWidth: 345, margin: "10px" }}>
          ...
          <CardActions>
            <Button
              size="small"
              color="primary"
              href="https://medium.com/@ishaninfo56/the-devops-lifecycle-46f1ae211dd"
            >
              Read More
            </Button>
          </CardActions>
        ...
        <Card sx={{ maxWidth: 345, margin: "10px" }}>
          <CardMedia component="img" height="250" src="images/Enter.jpg" />
          <CardContent>
            <Typography variant="h6" fontWeight="bold">
          ...
          <CardActions>
            <Button
              size="small"
              color="primary"
              href="https://medium.com/@ishaninfo56/what-is-enterprise-application-development-a0fc3b8c3647"
            >
              Read More
            </Button>
          </CardActions>
